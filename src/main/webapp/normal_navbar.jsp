<nav class="navbar navbar-expand-lg navbar-dark primary-background">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="Login_page.jsp"><i
					class="fa-solid fa-user all-margin"></i>Login</a></li>
			<li class="nav-item"><a class="nav-link" href="register_page.jsp"><i
					class="fa fa-user-plus all-margin"></i>Sign Up</a></li>
